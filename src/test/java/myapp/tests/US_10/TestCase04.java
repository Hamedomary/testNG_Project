...
public class TestCase04 {
    ...
    @Test(priority = 8)
    public void step8_enterPassCompoundLowerCase() {

        // User provides a password compound of lowercase letters and numbers
        vendorRegisterPage.passwordInput.sendKeys("spring12345");
    }
