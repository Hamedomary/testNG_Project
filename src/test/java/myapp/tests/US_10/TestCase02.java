...
public class TestCase02 {
    ...
    @Test(priority = 8)
    public void step8_enterPassRepetitive() {

        // User provides repetitive characters in the password field
        vendorRegisterPage.passwordInput.sendKeys("1212121212");
    }

    @Test(priority = 9)
    public void step9_verifyWeakWarningIsVisible() {

        // Verify (Too short) text is visible under password field
        Assert.assertTrue( vendorRegisterPage.weakWarning.isDisplayed() );
    }
}
