...
public class TestCase04 {
    ...
    @Test
    public void incorrectMatchtPass() throws InterruptedException {
...
//        User click on the current password and type wrong password
        ExtentReportUtils.pass("User enters current password");
...
//        User click on the new password and type the new password
        ...
        myaccountpage.new_password.sendKeys(faker.internet().password(12,13,true,true,true));
...
//        User click on the confirm password and type same password  typied on the new password
        ...
        myaccountpage.confirm_password.sendKeys(faker.internet().password(12,13,true,true,true));
...
//        Verify the Your current password is incorrect.
       Assert.assertTrue(myaccountpage.incorrectMatchPass.isDisplayed());
