...
public class Locators {
    ...
    @FindBy(xpath = "//button[@title='Quick View']/following-sibling::a[contains(@href,'add-to-cart')]")
    public WebElement addProductCard;
    @FindBy(xpath = "//a[@class='cart-toggle']/i[@class='w-icon-cart']")
    public WebElement openCart;
    @FindBy(xpath = "//div[@class='yith-wcwl-add-button']/a[@href='?add_to_wishlist=13222']")
    public WebElement productInWishlists;
